...
const PROOF = [
  ...
  { icon: Check, label: 'No account', detail: 'No email, no password, no sign-in wall between you and the thing working.' },
    ...
    <div className="step-enter">
      <section className="grid items-center gap-8 pt-4 sm:pt-8 lg:grid-cols-[1.05fr_1fr] lg:gap-12">
        <div>
          ...
          <p className="lede mt-6">
            Drop the syllabi your professors handed out. Every deadline, exam and class time gets pulled out. Send the lot to Google, Apple or Outlook in a
            single file.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <button type="button" onClick={sample} className="btn btn-secondary">
              See it on a sample
            </button>
          </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-line text-xs font-semibold uppercase tracking-wider text-muted">
                ...
                <th className="px-5 py-3 font-semibold text-accent">Syllabify</th>
              </tr>
            </thead>
      ...
      <section className="mt-20 text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-2">
          <p className="text-sm text-muted">This is free and always will be. If it saved you an evening, you can say thanks.</p>
          <SupportLink />
        </div>
      </section>
    </div>
